...
func TestCreateSong_Success(t *testing.T) {
	...
	handler := NewSongHandler(svc, rdb)
...
func TestGetAllSongs_Success(t *testing.T) {
	...
	expectedSongs := []model.Song{
		{SongID: 1, Name: "Song One", GenreID: 1, Link: "link1"},
		{SongID: 2, Name: "Song Two", GenreID: 2, Link: "link2"},
	}
...
func TestGetSongByID_Success(t *testing.T) {
	...
	expectedSong := &model.Song{SongID: 1, Name: "Test Song", GenreID: 1, Link: "testlink"}
